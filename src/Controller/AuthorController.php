...
class AuthorController extends AbstractController
{
    ...
    public function list(AuthorRepository $repository)
    {
        ...
        $authors2= $repository->showAllAuthorsOrderByEmail();
        return $this->render("author/listAuthors.html.twig",
            array("tabAuthors"=>$authors,"tab_Authors"=>$authors2));
    ...
    {
        $author = new  Author();
        $author->setUsername("mohammed");
        $author->setEmail("mohammed@gmail.com");
